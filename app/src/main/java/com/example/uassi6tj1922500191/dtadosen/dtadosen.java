...
import com.example.uassi6tj1922500191.MainActivity;
import com.example.uassi6tj1922500191.R;
import com.example.uassi6tj1922500191.RequestHandler;

import java.util.HashMap;

public class dtadosen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dta_dosen);

        txtetNIDN = (EditText) findViewById(R.id.etx_NIDN);
        txtetNmDosen = (EditText) findViewById(R.id.etx_nm_dosen);
        txtetJabatan = (EditText) findViewById(R.id.etx_jabatan);
        txtetGolongan = (EditText) findViewById(R.id.etx_golongan);
        txtetKeahlian = (EditText) findViewById(R.id.etx_keahlian);
        txtetStudi = (EditText) findViewById(R.id.etx_studi);
    }
    ...
    public void save(View view){
        ...
        class save2 extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(dtadosen.this, "Add...", "Wait...", false, false);
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String res = rh.sendPostRequest("http://192.168.117.220/mobtech/tmbh_dosen.php", params);
                return res;
            }
            ...
            protected void onPostExecute(String s) {
                ...
                if (s.equals("berhasil")){
                    Intent i = new Intent(dtadosen.this, MainActivity.class);
                    startActivity(i);
                }else {
                    Toast.makeText(dtadosen.this, "Data harus lengkap", Toast.LENGTH_SHORT).show();
                }
            }
        }
        save2 ae = new save2();
